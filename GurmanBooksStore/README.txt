...
then test it..... working....


2122
start part-3.2 product CRUD............
create Product class to .Model and add data which is provided by you......
add product to the DB by modify ApplicationDbContext.cs...............
add migration "AddProductToDb (20231121033145_AddProductToDb)" and update database........
apply Required method on "Title", "ISBN" and "Author", create add migration "AddValidationToProduct(20231121033311_AddValidationToProduct)" and Update database
...
2338
Modify ProductController.cs file the Upsert method code................
update API call to include the Category and CoverType Properties.....
then modify the product index view file, add properties- Title, ISBN, Price, Author and Category........
Modify URL in  product.js file by adding properties......
modify the _Layout.cshtml file to a new link to product...........


1205
run the application.....but in product showing category data because I didn't change the js file in product index view , it's link with category.js..
then I changed js file and run application.......now it's working......

1211
start part-3.3 Product CRUD
modify the Upsert product view file............

2023-11-21
1007
copy and paste link of tinycloud api for product....
product is not working.... 

2023-11-27
2013
start part-4
I tried to do part-4 at college on pc but it's not showing product table in SQL server but when i looked at my laptop it's showing...
so i decided to complete part-4 at my laptop......


2019
copy and paste upsert and delete code in ProductController.cs from https://github.com/Rico-Jose/BulkyBook/tree/master which id provided by you...
2024
create images/products folder in wwwroot and download book's cover images from google.....
...
2023-12-05
1050
I had problem with  Area/Customer/Views/Home/Index.cshtml file because of code after lots of try i solve this by deleting this file and add new one rewrite code...
...
1357
move README.md file to master branch.......