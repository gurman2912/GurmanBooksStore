...
add migration "AddProductToDb (20231121025124_AddProductToDb)" and update database........
apply Required method on "Title", "ISBN" and "Author", create add migration "AddValidationToProduct(20231121030413_AddValidationToProduct)" and Update database
